...
public interface QuadVertexSink extends VertexSink {
     ...
     */
    void writeQuad(float x, float y, float z, int color, float u, float v, int light, int normal);
     ...
     */
    default void writeQuad(Matrix4f matrix4f, float x, float y, float z, int color, float u, float v, int light, int normal) {
